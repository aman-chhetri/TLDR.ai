  ...
  return (
    <Box pt={15} pb={10} textAlign="center" maxW="3xl" mx="auto">
      ...
      <Text fontSize="lg" color={useColorModeValue('gray.500', 'gray.300')} mb={8}>
        <b>TLDR.ai</b> is a modern, AI-powered text summarization tool. ly condense long articles, blogs, research papers, or documents into concise, easy-to-read summaries. Whether you paste text or upload files, TLDR.ai helps you save time and focus on what matters most.
      </Text>
