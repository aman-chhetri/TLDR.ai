    ...
    <Box pt={15} pb={10} textAlign="center" maxW="3xl" mx="auto">
      ...
      <Box textAlign="left" bg={useColorModeValue('brand.50', 'brand.700')} borderRadius="lg" p={6} mb={6} boxShadow="md">
        ...
        <ul style={{ marginLeft: '1.5em', color: useColorModeValue('#444', '#e0e3ea') }}>
          <li>✨ <b>AI Summarization</b>: Get concise summaries of any text using advanced AI models via the Google Gemini API powered by the model.</li>
      ...
      <Box textAlign="left" bg={useColorModeValue('brand.50', 'brand.700')} borderRadius="lg" p={6} boxShadow="md">
        ...
        <ul style={{ marginLeft: '1.5em', color: useColorModeValue('#444', '#e0e3ea') }}>
          ...
          <li>🧠 <b>Google Gemini API</b> for state-of-the-art AI summarization </li>
...
function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      a: 'Summaries are generated by the Google Gemini AI model. While generally accurate, always review the output for important details.'
    },
    {
